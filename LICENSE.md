Эта работа распространяется под лицензией Creative Commons Attribution-NoDerivatives 4.0 International.

Вы можете свободно распространять этот код (включая коммерческое использование) при условии:
1. Обязательного указания нашего авторства.
2. Запрета на изменение, адаптацию или создание производных работ без нашего разрешения.
